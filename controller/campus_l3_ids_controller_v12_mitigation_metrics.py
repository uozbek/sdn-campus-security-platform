"""
campus_l3_ids_controller_v12_mitigation_metrics.py

Bu sürüm, campus_l3_ids_controller_v10_ml_ready.py dosyasından türetilmiştir.

Amaç:
- ML-ready IDS/IPS davranışını korumak
- Drop, rate-limit ve quarantine mitigation aksiyonlarını aktif kullanmak
- Mitigation latency ölçümlerini logs/mitigation_latency.csv dosyasına yazmak
- Flow rule timing ölçümünü mitigation kuralları için de genişletmek

Not:
- Bu sürüm saldırı/IPS aksiyon testleri içindir.
- Normal trafik baseline ölçümü için v11_runtime_metrics veya v10_observe_only kullanılmalıdır.
"""
import csv
import os
import json

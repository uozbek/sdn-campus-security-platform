...
Bu sürüm, campus_l3_ids_controller_v9.py dosyasından türetilmiştir.

Amaç:
- v9 içindeki çalışan L3 routing, IDS policy engine, rate-limit, drop ve quarantine davranışını korumak
- ML API entegrasyonunu bozmadan devam ettirmek
- Sonraki aşamalarda controller runtime metrics, flow rule timing ve mitigation latency ölçümlerini eklemek

Not:
- v9 stabil sürüm olarak korunacaktır.
- v10_ml_ready deneysel ML/runtime-metrics geliştirme sürümüdür.
"""
import csv
import os
import json

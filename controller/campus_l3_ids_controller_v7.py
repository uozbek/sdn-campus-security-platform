...
class CampusL3IdsControllerV7(app_manager.RyuApp):
    """
    Campus L3 IDS Controller V7.
    ...
    This version applies only OpenFlow drop mitigation.
    Rate-limit and real quarantine forwarding are planned for later phases.
    """

    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(CampusL3IdsControllerV7, self).__init__(*args, **kwargs)
        ...
        self.logger.info("Campus L3 IDS Controller V7 started")

...
class CampusL3IdsControllerV8(app_manager.RyuApp):
    """
    Campus L3 IDS Controller V8.
    ...
    This version applies OpenFlow drop mitigation and OpenFlow meter-based rate-limit mitigation.
    Real quarantine forwarding is planned for a later phase.
    """

    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(CampusL3IdsControllerV8, self).__init__(*args, **kwargs)
        ...
        self.logger.info("Campus L3 IDS Controller V8 started")

...
| BIB167 | 2023.0 | A review of opportunities and challenges of chatbots in education                                       |                          |                                               | Full text ile gözden geçirildi                | Full text ile gözden geçirildi                | Low                        |
...
### 3.x. NSL-KDD Veri Setinin Bu Tezdeki Konumu

NSL-KDD, KDD Cup 99 veri setindeki tekrar kayıtlar ve değerlendirme yanlılığı gibi sorunları azaltmak amacıyla önerilmiş, IDS literatüründe uzun süre yaygın biçimde kullanılmış klasik bir karşılaştırma veri setidir (Tavallaee vd., 2009; Khalid vd., 2024). Bu yönüyle NSL-KDD, geleneksel makine öğrenmesi tabanlı saldırı tespit çalışmalarının tarihsel gelişimini anlamak için yararlı bir referans noktası sunmaktadır. Bununla birlikte, veri setinin üretildiği trafik bağlamı güncel SDN, IoT ve DDoS saldırı yüzeylerini tam olarak temsil etmediğinden, modern ağ güvenliği çalışmalarında elde edilen sonuçların doğrudan güncel ağ ortamlarına genellenmesi dikkatli değerlendirilmelidir (Guerra vd., 2022; Sharafaldin vd., 2019).

Bu nedenle NSL-KDD bu tezde deneysel veri seti olarak kullanılmamıştır. Tez kapsamında NSL-KDD yalnızca klasik IDS literatürünü ve eski benchmark odaklı çalışmaların yöntemsel konumunu açıklamak için sınırlı ve bağlamsal düzeyde anılmaktadır. Bu çalışmanın deneysel omurgası ise güncel DDoS trafiği, akış tabanlı özellik çıkarımı ve SDN çalışma zamanı doğrulamasıyla daha uyumlu olan CIC-DDoS2019 ve CICFlowMeter-style özellikler üzerine kurulmuştur. Böylece tez, eski benchmark veri setleri üzerinde yüksek sınıflandırma başarımı raporlamaktan ziyade, SDN tabanlı kampüs ağı senaryosunda runtime inference, controller policy üretimi ve OpenFlow tabanlı önleme aksiyonlarını birlikte değerlendirmeyi hedeflemektedir.

...
- Teknik marker sayısı: `0`
- APA metin içi atıf sinyali sayısı: `9`
- Kaynakça bölümündeki APA-benzeri kaynak satırı sayısı: `94`

## 6. Not

Bu rapor otomatik ön kontroldür. Tablo/şekil başlıklarının gerçek Word caption alanı olup olmadığı ve Word Tablo/Şekil Listesi ile uyumu nihai aşamada Microsoft Word üzerinde ayrıca kontrol edilmelidir.
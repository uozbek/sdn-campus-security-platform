...
## 4.8. Hibrit Politika Karar Mekanizması
...
## 4.10. Loglama ve Deneysel İzlenebilirlik
...
## 4.11. Model-Controller Karşılaştırma Yöntemi
...
## 4.13. Tezde Kullanılan Ana Deney Paketi
...
## 4.14. Yöntemin Genel Değerlendirmesi
...
## 4.15. Önerilen SDN Tabanlı IDS/IPS Prototipinin Çalışma Zamanı Doğrulaması

### 4.15.1. Çalışma Zamanı Doğrulama Aşamasına Genel Bakış
...
### 4.15.3. Deneysel Çıktılar ve Artifact Yapısı
...
### 4.15.4. Tekrarlı Çalışma Zamanı Doğrulama Sonuçları
...
### 4.15.5. Denetleyici Taraflı Politika Aksiyon Dağılımı
...
### 4.15.6. Final XGBoost Top-20 Modelinin Runtime Tahmin Dağılımı
...
### 4.15.7. Protocol-Aware Final Policy Yorumu
...
### 4.15.8. SDN Denetleyicisi Önleme Aksiyonları
...
### 4.15.9. Flow-Level Model ve Denetleyici Karşılaştırması
...
### 4.15.10. Saldırı Olasılığı ve Final Policy Eşlemesi
...
## 4.16. Bölüm 4 Genel Kapanış Değerlendirmesi
...
### 4.16.1. Deneysel Koşuların Canonical ve Diagnostic Olarak Ayrılması
